      ...
      <div className="mx-auto max-w-3xl px-5 py-14 md:px-8 md:py-20">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          <a
            ...
            className="flex items-start gap-3 rounded-lg border border-line p-5 transition hover:border-yellow-400"
          >
            <Phone size={20} className="mt-0.5 text-yellow-400" />
            <div>
          ...
          <a
            ...
            className="flex items-start gap-3 rounded-lg border border-line p-5 transition hover:border-yellow-400"
          >
            <Mail size={20} className="mt-0.5 text-yellow-400" />
            <div>
          ...
          <div className="flex items-start gap-3 rounded-lg border border-line p-5">
            <MapPin size={20} className="mt-0.5 text-yellow-400" />
            <div>
              <p className="font-display text-sm font-bold text-ink">
                Service Area
              </p>
